namespace TemeGC
{
    internal class S11
    {
        ...
        public static PictureBox P1(PictureBox pbi)
        {
            ...
            pb.Size = new Size(Tema11.Form1.width, Tema11.Form1.height);
            g = pb.CreateGraphics();
            PaintEverything();
        ...
        public static void PaintEverything()
        {
            ...
            g.DrawString(str, new Font("Arial", 6), new SolidBrush(Color.Red), new PointF(30, Tema11.Form1.height - 30));
            g.FillRectangle(new SolidBrush(Color.Black), 700, Tema11.Form1.height - 50, 130, 50);
            g.DrawString("CONTINUE", new Font("Arial", 6), new SolidBrush(Color.Red),
                new PointF(730, Tema11.Form1.height - 30));

            g.FillRectangle(new SolidBrush(Color.Purple), 850, Tema11.Form1.height - 50, 130, 50);
            g.DrawString("CLEAR", new Font("Arial", 6), new SolidBrush(Color.Red), new PointF(880, Tema11.Form1.height - 30));
            //Lower Panel #end
        }
    ...
    class InfoPanel
    {
        ...
        {
            if (e.X > 700 && e.X < 830 && e.Y > Tema11.Form1.height - 50 && e.Y < Tema11.Form1.height)
                S11.PhaseAdd();
            if (e.X > 850 && e.X < 980 && e.Y > Tema11.Form1.height - 50 && e.Y < Tema11.Form1.height)
                S11.PhaseClear();
        }
    } //Working Well
    ...
    class GraphPanel
    {
        ...
        {
            if (e.Y < Tema11.Form1.height - 100)
                if (S11.phase == S11.PhaseType.Draw)
                {
